export const SERVICES = [
  ...
  { name: 'Product Service', url: 'http://localhost:3002', port: 3002, icon: '📦' },
  { name: 'Cart Service', url: 'http://localhost:3003', port: 3003, icon: '🛒' },
  { name: 'Order Service', url: 'http://localhost:3004', port: 3004, icon: '📋' },
